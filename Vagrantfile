...
Vagrant::Config.run do |config|
  ...
  # See: http://vagrantup.com/v1/docs/config/vm/host_name.html
  config.vm.host_name = "vm-licpro"
  ...
  config.vm.forward_port 81, 8090
  config.vm.forward_port 82, 8000
  ...
  config.vm.share_folder("v-web",  "/var/www", "./projects", :nfs => false)
